...
- (void)updateLoginStatus
{
    ...
    else
    {
        ...
        [MGUtilities showStatusNotifier:LOCALIZED(@"LOGIN_ERROR")
...
-(void) performParsing {
    ...
    NSArray* array = [CoreDataController getFavoriteRealEstate];
    
    NSMutableArray* tempArray = [NSMutableArray new];
    
    for(int x = 0; x < array.count; x++) {
        
        Favorite* fave = [array objectAtIndex:x];
        RealEstate* realEstate = [CoreDataController getRealEstateByRealEstateId:[fave.realestate_id intValue]];
...
//            }
            ...
            [tempArray addObject:realEstate];
        }
        
    }
    
    listView.arrayData = tempArray;
}
