...
@interface ForRentViewController ()

@end

@implementation ForRentViewController
...
-(void) performParsing {
    ...
    NSArray* array = [CoreDataController getRealEstatesForSaleOrRent:LOCALIZED(@"FOR_RENT")];
