    ...
    <script type="text/javascript">
        $(function(){
            ...
            var marker = new google.maps.Marker({
                    position: new google.maps.LatLng( <?php echo "$realestate->lat, $realestate->lon";?>, true ),
                    map: map,
                    title: 'Here!'
                });
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Update Real Estate</h3>
        </div>
                ...
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Price" name="price" required value="<?php echo $realestate->price; ?>">
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Beds" required name="beds" id="website" value="<?php echo $realestate->beds; ?>">
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="featured">
                          ...
                          <option value="1" <?php echo $realestate->featured == 1 ? "selected" : ""; ?> >Real Estate Featured</option>
                          <option value="0" <?php echo $realestate->featured == 0 ? "selected" : ""; ?> >Real Estate Not Featured</option>
                        </select>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Lot Size" required name="lot_size" value="<?php echo $realestate->lot_size; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Price/Sqft" required name="price_per_sqft" value="<?php echo $realestate->price_per_sqft; ?>">
                      </div>
                          ...
                          <?php
                              if($propertytypes != null) {
                                  foreach ($propertytypes as $propertytype)  {
                                        ...
                                        $selected = "";
                                        if($propertytype->property_type == $realestate->property_type)
                                          $selected = "selected";

                                        echo "<option value='$propertytype->property_type' $selected>$propertytype->property_type</option>";
                                  }
                              }
                          ?>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="status">
                          ...
                          <option <?php echo $realestate->status == "For Sale" ? "selected" : ""; ?> value="For Sale">For Sale</option>
                          <option <?php echo $realestate->status == "For Rent" ? "selected" : ""; ?> value="For Rent">For Rent</option>
                          <option <?php echo $realestate->status == "Sold" ? "selected" : ""; ?> value="Sold">Sold</option>
                        </select>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Zip code" required name="zipcode" value="<?php echo $realestate->zipcode; ?>">
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="Description" rows="10" name="desc1" id="details"><?php echo $realestate->desc1; ?></textarea>
                      </div>
