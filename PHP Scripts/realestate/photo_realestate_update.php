                ...
                <div class="col-md-6">
                  ...
                  <form action="" method="POST">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Photo URL" name="photo_url" required value="<?php echo $photo_realestate->photo_url;?>" >
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Thumbnail URL" name="thumb_url" required  value="<?php echo $photo_realestate->thumb_url;?>" >
                      </div>
