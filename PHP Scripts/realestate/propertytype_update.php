            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                      <h3 class="panel-title">Update Property Type</h3>
                    </div>
                          ...
                          <div class="col-md-6" style="width:100%;">
                            ...
                            <form action="" method="POST">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" placeholder="Property Type" name="property_type" required value="<?php echo $propertytype->property_type; ?>">
                                </div>
                                <br /> 
                                <p>
